  ...
  main.innerHTML = `
    <div class="container" style="padding-top: 10rem; padding-bottom: 6rem; text-align: center;">
      ...
      <p class="section__subtitle" style="margin-bottom: 2rem;">
        A project with that ID is not available. Please return to the homepage to see the full list of projects.
      </p>
...
function renderHeader(project) {
  ...
  const actionsHtml = project.repoUrl
    ...
    : `<span class="btn btn--ghost" style="cursor: default;">Proprietary Code</span>`;
  ...
  headerEl.innerHTML = `
    <div class="container">
      ...
      <span class="project-detail-header__tag">${escapeHtml(project.tag)}</span>
...
function renderRelated(project) {
  ...
  relatedEl.innerHTML = `
    <div class="container">
      <h2 class="section__title" style="text-align:center; margin-bottom: 2rem;">Related Projects</h2>
